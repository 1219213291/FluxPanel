  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['car:info:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['car:info:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="800px" append-to-body>
      <el-form ref="infoRef" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="管理员ID" prop="manager">
                  <el-input v-model="form.manager" placeholder="请输入管理员ID" />
                </el-form-item>
...
function reset() {
  form.value = {
        carName: null,        carType: null,        createTime: null,        delFlag: null,        id: null,        image: null,        lat: null,        lng: null,        location: null,        manager: null,        price: null,        updateTime: null  };
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除小车信息编号为"' + _ids + '"的数据项？').then(function() {
    return delInfo(_ids);
  }).then(() => {
    getList();
